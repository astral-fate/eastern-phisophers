...
class Qus1Widget extends StatefulWidget {
  const Qus1Widget({Key key}) : super(key: key);

  @override
  _Qus1WidgetState createState() => _Qus1WidgetState();
}

class _Qus1WidgetState extends State<Qus1Widget> with TickerProviderStateMixin {
  final animationsMap = {
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'أسس علم الاجتماع ووضع النظريات\n المتعلقة ببناء الدول والعمران',
